...
const fetchRepo = async (username, reponame) => {
  if (!username && !reponame) throw new MissingParamError(["username", "repo"], urlExample);
  ...
  if (!data.user && !data.organization) throw new Error("Not found");
