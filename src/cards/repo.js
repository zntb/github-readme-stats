...
const getBadgeSVG = (label, textColor) => `
  <g data-testid="badge" class="badge" transform="translate(320, -18)">
    ...
    <text x="23" y="-5" alignment-baseline="central" dominant-baseline="central" text-anchor="middle" fill="${textColor}">
      ${label}
    </text>
  </g>
`;
...
const renderRepoCard = (repo, options = {}) => {
  ...
  const i18n = new I18n({ locale, translations: repoCardLocales });
